    ...
    <div className="flex h-full flex-col justify-between p-5">
      <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between">
            ...
            >
              <span className="bg-shop-dark-green text-white h-7 w-7 rounded-lg flex items-center justify-center font-black text-sm">
                A
              </span>
              <span>Airmart</span>
            </Link>
            ...
            {navigation.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  onClick={onNavigate}
                  className={`flex items-center justify-between rounded-lg px-3 py-2.5 text-xs font-medium transition duration-150 ${
                    active
                      ? "bg-shop-dark-green text-white font-semibold shadow-xs"
      ...
      <div className="border-t border-slate-200 pt-4 space-y-3">
        ...
        <div className="flex items-center justify-between px-2 pt-2 border-t border-slate-100">
          <span className="text-[11px] text-slate-400">Manage Session</span>
          <UserButton />
        </div>
      </div>
    </div>
