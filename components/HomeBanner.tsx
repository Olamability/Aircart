  ...
  return (
    <div className="py-16 md:py-0 bg-shop-light-pink rounded-lg px-10 lg:px-24 flex items-center justify-between">
      <div className="space-y-5">
        <Title className="text-xl md:text-3xl font-bold">Grab upto 50% off on <br />selected Headphones</Title>
        <Link 
        href={"/shop"}
      ...
      <div className="py-3"><Image className="hidden md:inline-flex rounded-lg" src={Ryan} alt="Headphones" width={200} height={300} /></div>
    </div>
  )
}
