    ...
    return (
      <div className="py-12 max-w-xl mx-auto text-center space-y-4">
        ...
        <p className="text-sm text-slate-500">
          {" "}
          Your merchant profile has not been fully configured yet. Set up your
          business profile to begin listing products.{" "}
        </p>{" "}
        <Link
          href="/vendor/profile"
        ...
        >
          {" "}
          <UserCheck className="h-4 w-4" /> Complete Store Profile{" "}
        </Link>{" "}
      </div>
    );
  }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h4 className="text-sm font-semibold text-amber-900">
                ...
                {stats.lowStockCount > 1 ? "s" : ""} Below 5 Units{" "}
              </h4>{" "}
              <p className="text-xs text-amber-700 mt-0.5">
                {" "}
                Replenish inventory to avoid fulfillment delays and out-of-stock
                delisting.{" "}
              </p>{" "}
            </div>{" "}
          </div>{" "}
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-slate-900">
                      ...
                      ₦{" "}
                      {ord.vendorTotal
                        ? ord.vendorTotal.toLocaleString()
                        : "0"}{" "}
                    </span>{" "}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      {" "}
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded ${item.stock === 0 ? "bg-rose-100 text-rose-800" : "bg-amber-100 text-amber-800"}`}
                      >
                        {" "}
                        {item.stock === 0
                          ? "Out of Stock"
